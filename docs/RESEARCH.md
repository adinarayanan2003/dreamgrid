...
- Held-out validation/test seed splits are API-backed, and the CLI can export JSON/CSV tables plus replayable planner failure-case traces.
...
3. Export rollout GIFs for selected replayed failure cases.
